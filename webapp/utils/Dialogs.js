sap.ui.define(
    ...
    function (Constants) {
        ...
        return {
            ...
            createOrderDetailsDialog: function (oData) {
                const oDateFormat = {
                    year: "numeric",
                    month: "short",
                    day: "numeric",
                ...
                const oDialog = new sap.m.Dialog({
                    ...
                    content: [
                        new sap.m.VBox({
                            items: [
                                new sap.m.Text({ text: `ID: ${oData.id}` }),
                                new sap.m.Text({ text: `Product ID: ${oData.productId}` }),
                                new sap.m.Text({ text: `Warehouse Name: ${oData.warehouseName}` }),
                                new sap.m.Text({ text: `Warehouse Location: ${oData.wareHouseLocation}` }),
                                new sap.m.Text({
                                    text: `Created On: ${new Date(oData.timestampCreated).toLocaleString(
                                        "en-US",
                                        oDateFormat
